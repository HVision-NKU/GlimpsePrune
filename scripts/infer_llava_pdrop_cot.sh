...
base_output_path="result/pdrop_${base_model_suffix}/viscot_bench"
...
MORE_ARGS="${MORE_ARGS} --layer_list ${layer_list} --image_token_ratio_list ${image_token_ratio_list}"
